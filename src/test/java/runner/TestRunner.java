...
@CucumberOptions(  // here we are adding properties
        ...
        dryRun = false, // this set to False and it checks if any step in feature has step definition 
        tags ="@desktop", // we will run our scenarios using tags on top of each scenario
